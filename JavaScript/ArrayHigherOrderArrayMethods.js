...
//Q1 => find the id of all the employees whose desg is IT and has served minimum of 6 years in your company.
const empIDs = employees.filter(emp=>emp.designation == 'IT' || emp.designation=='HR' && emp.end-emp.start>=6).map(emp=>emp.id)
console.log(empIDs);
